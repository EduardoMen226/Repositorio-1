...
namespace POO_U2_Inscripcion
{
    internal class Alumno
    {
        ...
        public Alumno(string nombreAlumnoEntrada, string apellidoPrimeroEntrada, string apellidoSegundoEntrada,
            DateTime fechaIncripcionEntrada, DateTime fechaNacimientoEntrada, string carreraEntrada/*Los valores de entrada*/)
        ...
        public string CalcularEdadAlumno1()
        {
            ...
            {
                edad = ((DateTime.Now - fechaNacimiento).Days) / 365;
                valorDeRetorno = string.Format("El alumno con matricula: {4} {0} {2} {3}. " + "Con carrera en {5} " +
                    ".Tiene la edad de: {1} años", nombreAlumno, edad, apellidoPrimero, apellidoSegundo, matricula, carrera);
            }
