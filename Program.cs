...
namespace POO_U2_Inscripcion
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Alumno objetoUno = new Alumno("Adrián Pedro", "Ortiz", Convert.ToDateTime("04-04-2022"));//llamar el constructor
            ...
            Alumno alumno1 = new Alumno("Daniela Ailyn", "Rodriguez", "Diaz", Convert.ToDateTime("25 - 06 - 2021"), Convert.ToDateTime("25 - 06 - 2003"),"ISC");
            Alumno alumno2 = new Alumno("Amador", "Rivera", "Martinez", Convert.ToDateTime("25 - 06 - 2021"), Convert.ToDateTime("25 - 06 - 2004"), "ISC");
            Alumno alumno3 = new Alumno("Ezequiel", "Sandoval", "Martinez", Convert.ToDateTime("25 - 06 - 2021"), Convert.ToDateTime("25 - 06 - 2003"), "ISC");
            Alumno alumno4 = new Alumno("Yolanda Elizabeth", "Zapata", "Gonzalez", Convert.ToDateTime("25 - 06 - 2021"), Convert.ToDateTime("25 - 06 - 2003"), "ISC");
            Alumno alumno5 = new Alumno("Sonia", "Huerta", "Carillo", Convert.ToDateTime("25 - 06 - 2021"), Convert.ToDateTime("25 - 06 - 2003"), "ISC");
            Alumno alumno6 = new Alumno("Alfonso", "Vargas", "Hernandez", Convert.ToDateTime("25 - 06 - 2021"), Convert.ToDateTime("25 - 06 - 2003"), "ISC");

            // Mandar llamar algun miembro
